...
class zebpayspot(Exchange, ImplicitAPI):
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        response = await self.privatePostExOrders(self.extend(request, params))
    ...
    async def fetch_trading_fee(self, symbol: str, params={}) -> TradingFeeInterface:
        ...
        if side is not None:
            request['side'] = side
        response = await self.privateGetExchangeFeeSymbol(self.extend(request, params))
        #
        # {
    ...
    async def cancel_order(self, id: str, symbol: Str = None, params={}):
        ...
        if id is None:
            ...
            response = await self.privateDeleteExOrders(self.extend(request, params))
        else:
            request['orderId'] = id
            response = await self.privateDeleteExOrdersOrderId(self.extend(request, params))
        #
        #    {
        #        "data": {
        #            "orderId": "12345",
    ...
    async def cancel_orders(self, ids, symbol: Str = None, params={}):
        ...
        response = await self.privateDeleteExOrdersCancelAll(self.extend(request, params))
        #
        #    {
        #        "data": {
        #            "orderId": "12345",
    ...
    async def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        if since is None:
            request['page'] = 1
        trades = await self.publicGetMarketTrades(self.extend(request, params))
        #
        #     [
        #         {
        #             "id" : "60014521",
    ...
    async def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        response = await self.privateGetExOrders(self.extend(request, params))
        #
        #     {
        #         "data": {
        #             "items": [
    ...
    async def fetch_order_trades(self, id: str, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        params = self.omit(params, ['timestamp'])
        tradeResponse = await self.privateGetExOrdersFillsOrderId(self.extend(request, params))
        #
        #         {
        #             "orderId": "456789",
        #             "symbol": "LINK_USDT",
